...
Acknowledgements: Used code from consulting session week 5 to create and display the tibble with the session information
...
```
Acknowledgements: Altered code from Consulting Session Week 5
